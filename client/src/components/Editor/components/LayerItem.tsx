        ...
        >
          <svg width="19.13" height="13" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="eye">
              ...
              <path d="M10.5648 1.96875C5.2823 1.96875 1 7.15178 1 8.46875C1 9.78572 5.2823 14.9688 10.5648 14.9688C15.8473 14.9688 20.1296 9.78572 20.1296 8.46875C20.1296 7.15178 15.8473 1.96875 10.5648 1.96875ZM10.5648 1.96875C8.24049 1.96875 6.35632 3.85179 6.35632 6.17463C6.35632 8.49748 8.24053 10.3805 10.5648 10.3805C12.8891 10.3805 14.7733 8.49748 14.7733 6.17463C14.7733 3.85179 12.8891 1.96875 10.5648 1.96875Z" stroke="#0E0E0E" stroke-width="2" stroke-linecap="round"/>
            </g>
          </svg>
        </div> 
          <div
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: `rotate(${open ? 0 : -90}deg)`, transition: 'transform 0.25s ease' }}>
              <g id="Controls">
                <path id="chevron-up" d="M14.0625 7.4375L9 12.5L3.9375 7.4375" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </g>
            </svg>
          </div>
          <div className={cx(
